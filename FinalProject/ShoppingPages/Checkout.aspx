<%@ Page Title="" Language="C#" StylesheetTheme="ShopTheme" MasterPageFile="~/ShoppingMaster.master" AutoEventWireup="true" CodeFile="Checkout.aspx.cs" Inherits="ShoppingPages_Checkout" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="codeBox" MaxLength="3" runat="server"></asp:TextBox>
    ...
    <label>ZIP: </label>
    <asp:TextBox ID="zipBox" MaxLength="5" runat="server"></asp:TextBox>
